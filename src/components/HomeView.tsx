...
import { Search, Zap, BatteryCharging, Shield, PenTool, Award, Sparkles, Plus, BookOpen } from 'lucide-react';
  ...
  return (
    <div className="bg-[#111317] text-[#e2e2e8]" id="home-view">
      ...
      <section className="relative min-h-[640px] flex flex-col justify-center items-center px-4 sm:px-6 lg:px-8 overflow-hidden bg-[#24262b] pt-16">
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto flex flex-col items-center gap-6 animate-fade-in px-4">
          ...
          <p className="text-[#c0c7d1] text-base sm:text-lg lg:text-xl max-w-2xl font-light leading-relaxed">
            Explore Indias most comprehensive database of EVs. Compare full specs side-by-side, calculate real-world battery ranges, and lock down local FAME subsidies.
          </p>
          ...
          {/* Quick pills below the search bar matching screenshots */}
          <div className="flex flex-wrap justify-center gap-2 sm:gap-3 mt-4 max-w-md sm:max-w-2xl">
            <button 
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-[#1a1c20] p-8 rounded-2xl border border-[#414750]/20 flex flex-col items-start gap-4">
